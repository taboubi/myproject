...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__myevents__ = __webpack_require__(496);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pipes_pipes_module__ = __webpack_require__(353);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__yellowspot_ng_truncate__ = __webpack_require__(483);
...
var MyeventsPageModule = /** @class */ (function () {
    ...
    MyeventsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__myevents__["a" /* MyeventsPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_3__myevents__["a" /* MyeventsPage */]),
...
//# sourceMappingURL=myevents.module.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__truncate_module__ = __webpack_require__(484);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__truncate_characters_pipe__ = __webpack_require__(485);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__truncate_words_pipe__ = __webpack_require__(486);
...
var MyeventsPage = /** @class */ (function () {
    function MyeventsPage(navCtrl, items, api, menu, modalCtrl, user, loadingCtrl) {
    ...
    MyeventsPage.prototype.ionViewCanEnter = function () {
        var _this = this;
    ...
    MyeventsPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        ...
        return new Promise(function (resolve, reject) {
            var seq = _this.items.querymylist().share();
            seq.subscribe(function (res) {
     ...
     */
    MyeventsPage.prototype.addItem = function () {
        var _this = this;
     ...
     */
    MyeventsPage.prototype.deleteItem = function (item) {
        this.items.delete(item);
    };
    /**
     * Navigate to the detail page for this item.
     */
    MyeventsPage.prototype.openItem = function (item) {
        this.navCtrl.push('ItemDetailPage', {
            item: item
        });
    };
    MyeventsPage.prototype.loadItems = function () {
        var _this = this;
        var loading = this.loadingCtrl.create({
            spinner: 'hide',
            content: "<img src=\"assets/svg/bars.svg\" width=\"100%\"/>"
        ...
        loading.present();
        var seq = this.items.querymylist().share();
        seq.subscribe(function (res) {
            _this.currentItems = res;
        }, function (err) {
    ...
    MyeventsPage.prototype.isItemShown = function (id) {
        if (this.itemsshown.indexOf(id) !== -1) {
            return true;
        }
        return false;
    };
    MyeventsPage.prototype.toggleItem = function (id) {
        console.log('toggle');
