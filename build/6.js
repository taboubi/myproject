...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__signup__ = __webpack_require__(505);
    ...
    SignupPage.prototype.validate = function () {
        ...
        if (!this.account.is_regular && !this.account.is_senior_service && !this.account.is_special_event) {
            ...
            var confirmAlert = this.alertCtrl.create({
                message: this.translateService.instant('WARNINGSERVICE'),
                buttons: [{
